        ...
        <template #header > 
            <BaseTableSetup>
              <template #searchs-area> 
                <TableButton class="mr-2" @click="showTheForm"> <i class="fa-solid fa-plus mr-1"></i> Add Sbo Adviser  </TableButton>
              ...
              <template #actions-area>
                <TableButton  :mode="true" class="mr-2" >    <i class="fa-regular fa-trash-can mr-2"></i> Selected (1 )
                </TableButton>
                <TableButton  :mode="true"> <i class="fa-regular fa-trash-can mr-1 "></i>  <span class="block">Delete All</span>
                </TableButton>
              </template>
                    ...
                    <td class="whitespace-nowrap py-4   ">
                      <div class="flex items-center">
                        ...
                        <div class="ml-4">
                          ...
                          <div class="text-gray-900">lindsay.walton@example.com</div>
                        </div>
                      </div>
                    </td>
                    
                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900">
                        Sultan Kudarat State Universiity (Isulan Campus)
                    </td>
                    <td
