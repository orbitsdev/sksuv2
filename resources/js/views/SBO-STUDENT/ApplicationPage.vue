    ...
    <div v-else>
      <div v-if="response != null">
        <div class="overflow-hidden bg-white shadow sm:rounded-lg">
          ...
          <div class="px-8">
              <button @click="showForm = true" class="border px-2 py-1 hover:shadow-lg cursor-pointer rounded-lg text-white bg-green-700 ">
                <div class="flex items-center ">
                  <span class="text-sm mr-1">Edit</span>  <i class="text-xs fa-solid fa-pencil"> </i>
                </div>
              </button>
          </div>
        </div>
                   ...
                   <!-- {{ response.response_requirements}} -->
                    <div v-for="rf in  response.response_requirements" :key="rf.id">
                        ...
                        <div v-if="rf.files.length > 0" class="  ">
                            ...
                            <div  class="inline-flex  mr-2 mb-1 text-green-800 bg-green-100  font-bold text-sm  flex-nowrap items-center justify-center   px-2 rounded-lg py-1 hover:shadow-lg cursor-pointer " v-for=" file in rf.files " :key="file.id">
                                <div class="mb-0.5">
                                    <div class="flex flex-wrap items-center">                                    
                                        <svg class="h-5 w-5 mr-1  text-green-800 font-bold " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                        ...
                        <div v-else class="flex items-center  rounded-full  ">
                          <div  class="inline-flex  mr-2 mb-1 text-gray-400    text-sm  flex-nowrap items-center justify-center   px-2 py-1  " >
                            <div class="mb-0.5">
                                <div class="flex flex-wrap items-center">                                    
