  ...
  <div class="pt-3 sm:mx-auto sm:w-full sm:max-w-md">
    <div class="bg-white sm:rounded-lg sm:px-10">
      <form class="space-y-3" @submit.prevent="registerUser">
        ...
        <BaseInput :label="'Firstname'" v-model="form.first_name"  :hasError="validationError.first_name" />
        <BaseInput :label="'Lastname'" v-model="form.last_name"  :hasError="validationError.last_name" />
        <BaseInput :label="'Email'"  v-model="form.email"  :hasError="validationError.email" />
        <BaseInputPassword
        :label="'Password'"
          :show="showPassword"
          ...
          <div>
            ...
            <div class="flex items-center justify-center mt-2">
                <div class="text-sm">
                    ...
                    <buttton @click="$emit('showLogin')" class="font-medium text-indigo-600 hover:text-indigo-500">Login </buttton> 
