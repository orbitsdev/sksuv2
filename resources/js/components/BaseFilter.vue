...
<template>
    <select class="w-full cursor-default rounded-md border border-gray-300 bg-white py-2 pl-3 pr-10 text-left shadow-sm focus:border-grey-400 focus:outline-none   sm:text-base" aria-haspopup="listbox" aria-expanded="true" aria-labelledby="listbox-label">
        <option value="vue"> <div> <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <!-- <div>
        <label id="listbox-label" class="block text-sm font-medium text-gray-700">Filter By</label>
